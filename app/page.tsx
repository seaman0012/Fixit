...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* Hero Section */}
      <section className="from-primary/10 to-background flex-1 bg-linear-to-b">
      ...
      <section className="bg-background py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader>
                <Wrench className="text-primary mb-2 h-10 w-10" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>คุยกับผู้ดูแลหอพักผ่านระบบ Comment ได้โดยตรง</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
